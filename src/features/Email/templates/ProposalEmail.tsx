...
export default function ProposalEmail({ authorName, authorOrganization, message, howHeard, phoneNumber, email }: Props) {
  return (
    <Html>
      <Head />
        ...
        <Container style={styles.container}>
          ...
          <Section>
            <Row>
              ...
              <Text className="text-[#9ca299] text-[14px] leading-[24px] mb-2.5">Mail: {email}</Text>
